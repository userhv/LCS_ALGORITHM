define internal i32 @kempld_gpio_direction_input(%struct.gpio_chip* %chip, i32 %offset) #0 {
entry:
  ...
  %call3 = call i32 @KEMPLD_GPIO_DIR_NUM(i32 %5)
  %6 = load i32, i32* %offset.addr, align 4
  %call4 = call i32 @kempld_gpio_bitop(%struct.kempld_device_data* %4, i32 %call3, i32 %6, i32 0)
  %7 = load %struct.kempld_device_data*, %struct.kempld_device_data** %pld, align 8
  %call5 = call i32 @kempld_release_mutex(%struct.kempld_device_data* %7)
  ret i32 0
}
